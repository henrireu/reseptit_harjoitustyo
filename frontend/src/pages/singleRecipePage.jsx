      ...
      <div className="px-2 sm:px-10 mt-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-10 my-3 sm:my-10">
          ...
          <div className="flex flex-col sm:flex-row items-center">
            <div className="inline-flex justify-center gap-1 bg-green-300 dark:bg-green-700 p-3 rounded-full">
        ...
        <div className="max-w-[1400px] mx-auto mt-5 bg-orange-200 dark:bg-gray-700 p-6">
